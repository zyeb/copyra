...
class HistoryTests: XCTestCase {
  ...
  func testAddingItemThatIsSupersededByExisting() {
    ...
    firstItem.application = "Copyra.app"
    ...
    secondItem.application = "Copyra.app"
  ...
  func testAddingItemFromCopyra() {
    ...
    let secondContents = [
      ...
      HistoryItemContent(
        type: NSPasteboard.PasteboardType.fromCopyra.rawValue,
        value: "".data(using: .utf8)
      )
    ]
    let second = HistoryItem()
    Storage.shared.context.insert(second)
    second.application = "Copyra.app"
