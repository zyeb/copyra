...
class HistoryItem {
  ...
  private static let transientTypes: [String] = [
    ...
    NSPasteboard.PasteboardType.fromCopyra.rawValue,
  ...
  var imageData: Data? {
    var data = embeddedImageData
    if data == nil, let url = universalClipboardImageURL {
  ...
  var hasImageContent: Bool {
    return embeddedImageData != nil || universalClipboardImageURL != nil
  }
  ...
  var fromCopyra: Bool { contentData([.fromCopyra]) != nil }
  var universalClipboard: Bool { contentData([.universalClipboard]) != nil }
  var embeddedImageData: Data? { contentData([.tiff, .png, .jpeg, .heic]) }
  var universalClipboardImageURL: URL? {
    guard universalClipboardImage else { return nil }
