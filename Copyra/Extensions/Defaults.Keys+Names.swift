...
extension Defaults.Keys {
  ...
  static let menuIcon = Key<MenuIcon>("menuIcon", default: .copyra)
  ...
  static let size = Key<Int>("historySize", default: 5_000)
  ...
  // Large-history tuning knobs.
  static let largeHistoryThreshold = Key<Int>("largeHistoryThreshold", default: 3_000)
  static let largeHistoryPageSize = Key<Int>("largeHistoryPageSize", default: 200)
  static let largeHistoryMaxLoadedPages = Key<Int>("largeHistoryMaxLoadedPages", default: 3)
  static let thumbnailCacheCountLimit = Key<Int>("thumbnailCacheCountLimit", default: 96)
  static let thumbnailCacheTotalCostLimit = Key<Int>("thumbnailCacheTotalCostLimit", default: 24 * 1024 * 1024)
}
